...
class _$_LoadSuccess implements _LoadSuccess {
  const _$_LoadSuccess(final List<Task> tasks) : _tasks = tasks;
  ...
  @override
  String toString() {
    return 'TasksState.loadSuccess(tasks: $tasks)';
  }
...
abstract class _LoadSuccess implements TasksState {
  const factory _LoadSuccess(final List<Task> tasks) = _$_LoadSuccess;
...
class _$_LoadFailure implements _LoadFailure {
  ...
  @override
  String toString() {
    return 'TasksState.loadFailure(failure: $failure)';
  }
